...
public class FoodMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.fragment_food_menu, container, false);
    ...
    class MyAdapter extends FragmentPagerAdapter implements TabHost.TabContentFactory
        ...
        {
            switch (position){
                case 0 : return new JuiceFragment();
                case 1 : return new SandwichFragment();
                case 2 : return new MainCourseFragment();
                case 3 : return new SpecialFragment();
            }
            return null;
        }
